% EMG check YL - Alyssa Data
% Version w/ comments added

% load('Alyssa.mat'); % expData needed to run the code

% one condition for trial
conds={'Baseline'};


% eventsr={'RHS','LTO','LHS','RTO'};  % order of events
eventsr={'LHS','RTO','RHS','LTO'};    % order of events
