...
% change depending on right or left heel strike first
event={'LHS','RTO','RHS','LTO'};    % left heel strike
% events={'RHS','LTO','LHS','RTO'}; % right heel strike

alignmentLengths=[16,32,16,32];

% Remove any muscles that fell off/did not collect data - code breaks 
% muscle={'MG','RF','VL','SEMT','TA'};
% muscle={'TA', 'PER', 'SOL', 'LG', 'MG', 'BF', 'SEMB', 'SEMT', 'VM', 'VL', 'RF', 'TFL', 'GLU', 'ADM', 'HIP'}; % includes hip muscle
% muscle={'TA', 'PER', 'SOL', 'LG', 'MG', 'BF', 'SEMB', 'SEMT', 'VM', 'VL', 'RF', 'TFL', 'GLU', 'ADM'};
muscle={'TA', 'PER', 'SOL', 'LG', 'BF', 'SEMB', 'SEMT', 'VM', 'VL', 'RF', 'TFL', 'GLU', 'ADM'};     % list of muscles w/out MG
